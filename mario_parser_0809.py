...
def mario_parser_function(youtube_id = "PI2o0fNKD8g"):
    try:
        # config
        ...
        output_folder_1 = "output_test_0809"
        ...
        captured_frames = convert_mario_to_jpg.extract_frames(output_filename, start_time=start_time_sec, end_time=end_time_sec, interval_frames=capture_per_n_frames, output_folder = output_folder_1)
        ...
        dict_to_infer = black_threshold_test.get_image_title_black_game_attr(output_folder_1)
        starting_frame = black_threshold_test.infer_starting_frame(dict_to_infer, start_frame=0, end_frame=total_frames)
        ...
        infer_filename = test_one_frame_detect_0801.infer_and_combine_to_jpg(filtered_captured_frames, output_filename = "output0809.jpg")
